    ...
    <section id="hero" className="hero relative flex w-full h-screen select-none items-center justify-center" aria-label="hero" >
      <div className="z-10 flex flex-col  w-full items-center text-title 2xl:text-[10vw] 2xl:space-y-16 font-bold  uppercase text-accent-300">
        <div className="title 2xl:py-16">
          ...
          <h1 ref={(el) => (titles.current[0] = el)} className="translate-y-96 overflow-visible" style={{ fontSize: '80%' }}>
            Hey, I&apos;m Varun
          </h1>
        </div>
        <div className=" title 2xl:py-16">
        <h1 ref={(el) => (titles.current[1] = el)} className="translate-y-96 font-outline-3 md:font-outline-4 text-transparent overflow-visible" style={{ fontSize: '80%' }}>
            Hey, I&apos;m Varun
          </h1>
        </div>
        <div className=" title 2xl:py-16">
          <h1 ref={(el) => (titles.current[2] = el)} className="translate-y-96" style={{ fontSize: '80%' }}>
            Hey, I&apos;m Varun
          </h1>
        </div>
      </div>
